...
This repository is, for now, a body of **design theory** — not yet code.
...
Early theory. Open problems are named, not hidden — see the impossibility results
(`THEORY.md` §5) and residual tensions (`A4-NOMINATION.md` §8).
